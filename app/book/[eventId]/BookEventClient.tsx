...
import { getEventById, getBookingBySlot, createBooking, checkExistingBooking, getDevicesByIds, getBookingsByEventId } from '@/lib/firestore'
...
export default function BookEventClient() {
  ...
  // Handle both [eventId] and [...slug] routes
  const eventId = (params.eventId || (params.slug as string[])?.[0]) as string
